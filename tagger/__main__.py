...
extra_dirs = [os.path.join(os.getcwd(), 'web/tagger/templates'), os.path.join(os.getcwd(), 'web/tagger/static')]
...
app.run(port=args.port, debug=args.d, extra_files=extra_files)
